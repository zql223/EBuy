...
public class Params implements Serializable{
    ...
    //增加查询参数
    public com.example.utils.Params addEqual(String column, Object value){
        selectParams.put(column,value);
        return this;
    }
    public com.example.utils.Params addLike(String column, Object value){
        likeParams.put(column,value);
        return this;
    }
    //增加设置参数
    public com.example.utils.Params addSet(String column, Object value){
        updateParams.put(column,value);
        return this;
    }
    //设置排序
    public com.example.utils.Params orderDesc(String cloumn){
        sortParams.put(cloumn,"desc");
        return this;
    }
    public com.example.utils.Params orderAsc(String cloumn){
        sortParams.put(cloumn,"asc");
        return this;
    }
    //设置分页
    public com.example.utils.Params openPager(int startIndex, int pageSize){
        this.isOpenPager=true;
        this.startIndex=startIndex;
        this.pageSize=pageSize;
        return this;
    }
    public com.example.utils.Params addSaveParam(String column, Object value){
